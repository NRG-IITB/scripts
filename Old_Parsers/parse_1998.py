...
# ============================================================
# ===============  DETAILED PARSER (1998) =====================
# ============================================================

def parse_detailed_1998(path):
    data = {}
    ...
    with pdfplumber.open(path) as pdf:
        for page in pdf.pages:
            ...
            # Create entry for this constituency
            ...
            for line in text.split("\n"):
                ...
                if m:
                    ...
                    # Assign to latest constituency on that page
                    last_no = heads[-1][0]
                    cid = f"S01-{last_no}"
...
def merge_1998(summary, detailed):
    merged = []
...
summary_path = "/mnt/d/IIT_B_Project/SL_NON GIT/pdf_before 2009/summary/1998_summary_trimmed.pdf"
detailed_path = "/mnt/d/IIT_B_Project/SL_NON GIT/pdf_before 2009/detailed/1998-detailed.pdf"
output_path = "parsed_new/parsed_1998.json"

summary = parse_summary_1998(summary_path)
detailed = parse_detailed_1998(detailed_path)
merged = merge_1998(summary, detailed)
